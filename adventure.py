                ...
                while in_sains:
                    ...
                    if s_option == "1":
                        ...
                        if money_in_wallet >= 2:
                            sains_choice_gen("a nice blue bic pen", "a pen", "2. Buy pen")
                            money_in_wallet -= 2
                            update_money_in_inventory(inventory, money_in_wallet)
                        else: 
                            cant_afford()
                        ...
                        if money_in_wallet >= 4.95:
                            ...
                            update_money_in_inventory(inventory, money_in_wallet)
                            sains_choice_gen("a block of post-it notes in every colour of the rainbow","expensive post-it notes", "3. Buy expensive post-it notes")
                        else: 
                            cant_afford()
                    elif s_option == "4":
                        in_sains = False
